...
4. **Verify release** (optional):
   ...
   curl -s "https://api.github.com/repos/meta-ads-mcp/releases/latest" | grep -E '"tag_name"|"name"'
...
- **GitHub Releases**: https://github.com/meta-ads-mcp/releases
- **PyPI Package**: https://pypi.org/project/meta-ads-mcp/
- **Actions History**: https://github.com/meta-ads-mcp/actions 