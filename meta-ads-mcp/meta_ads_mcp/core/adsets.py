...
from .ryzon_defaults import apply_ryzon_adset_defaults
...
async def create_adset(
    ...
    account_id, targeting, dsa_beneficiary, dsa_payor = apply_ryzon_adset_defaults(
        account_id, targeting, dsa_beneficiary, dsa_payor
    )
