                ...
                try:
                    ...
                    if access_token:
                        ...
                        if auth_manager.app_id == "YOUR_META_APP_ID" or not auth_manager.app_id:
                            ...
                            logger.error("Please set META_APP_ID environment variable")
                        else:
            ...
            if 'access_token' not in kwargs or not kwargs['access_token']:
                ...
                return json.dumps({
                    "error": {
                        "message": "Authentication Required",
                        "details": {
                            "description": "No valid Meta access token available",
                            "action_required": "Set META_ACCESS_TOKEN environment variable",
                            "how_to_get_token": "Generate a token at https://developers.facebook.com/tools/explorer/",
                            "troubleshooting": "Check that META_ACCESS_TOKEN is set in your environment or Claude Desktop config"
                        }
                    }
                }, indent=2)
